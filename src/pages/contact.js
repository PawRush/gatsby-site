...
const ContactPage = ({ data }) => (
  <BodyClassName className="page">
    <Layout>
      <SEO
        title="Contact"
        keywords={['Marcy Sutton', 'contact', 'web developer']}
      />
      <div className="generic-wrap page-post-wrap">
        <section className="page-post-detail contact-detail">
          <RouteTargetHeading>Holla Back</RouteTargetHeading>
          <div>
            <p>
              <em>
                Want to get in touch? Fill out this form, and I’ll do my best to
                get back to you.
              </em>
            </p>
            <p>
            ...
            <div>
              ...
              <form
                ...
                method="POST"
                data-netlify="true"
                data-netlify-honeypot="pooh-field"
              >
                <p style={{ display: `none` }}>
                  <label>
                    Don’t fill this out if you're human:{' '}
                    <input name="pooh-field" />
                  </label>
                </p>
